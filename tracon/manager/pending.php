          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> PENGAJUAN CUTI PIMPINAN DIVISI</h3>
              </div>
              ...
              <!--<button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
                  $no = 0;
                  $pimpinan = 'Plant Manager : Ikin';
                  $status = 'p';
                  $query = mysqli_query($koneksi,"SELECT * FROM pakai WHERE pimpinan='$pimpinan' AND status='$status'");
                  ...
                  <td> <?= $karyawan['nomor'] ?></td>
                        ...
                        :'<h5><span class="badge badge-succes">Diterima<i class="fas fa-check"></i></span></h5>');?>
                        </td>
                        <td>
                          <?php
                          if($karyawan['status'] == 'p'){
                            ?>
                           <!-- <a href="manager/proses_cuti.php?nomor=<?= $karyawan['nomor'] ?>&&s=N" class="btn btn-danger btn-sm"
                            onclick="return confirm('Tolak Pengajuan ini?')">
                            <i class="fas fa-times"></i>
                          </a>
                          <a href="manager/proses_cuti.php?nomor=<? $karyawan['nomor'] ?>&&s=Y" class="btn btn-success btn-sm"
                          onclick="return confirm('Terima Pengajuan ini?')">
                          <i class="fas fa-check"></i>
                          </a> -->
                          <?php } ?> <a href="index.php?page=approvemn&& nomor=<?php echo $karyawan['nomor'];?>"  class="btn btn-sm btn-primary">Detail</a>
                        </td>
                  </tr>
                     <?php }?>
                  </tbody>
