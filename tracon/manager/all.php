          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">PENGAJUAN CUTI KARYAWAN</h3>
              </div>
             ...
             <br></br>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  $query = mysqli_query($koneksi,"SELECT * FROM pakai WHERE pimpinan='$pimpinan'");
                 ...
                 <tr>
                        ...
                        : ($karyawan[status]=== 'N'?
                        '<h5><span class="badge badge-danger">Tolak<i></i></span></h5>'
                        ...
                        <td>
                            ...
                            if($karyawan['status']== 'p'){
                                ?>
                                <a href="approve/cuti_hasil.php?npk=<?= $karyawan['nomor'] ?>&&s=N" class="btn btn-danger btn-sm"
                                    onclick="return confirm('tolak pengajuan ini?')">
                                    <i class="fas fa-">Tolak<i>
                                </a>
                                <a href="approve/cuti_hasil.php?npk=<?= $karyawan['nomor'] ?>&&s=Y" class="btn btn-success btn-sm"
