          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">RIWAYAT CUTI SAYA</h3>
              </div>
              ...
              <!-- <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
                  $no = 0;
                  $query = mysqli_query($koneksi,"SELECT * FROM pakai WHERE nama='$_SESSION[nama]'");
                    while ($karyawan = mysqli_fetch_array ($query)){
                      $no++
                    ?> 
                  <tr>
                  <td><?php echo $karyawan['nomor'];?></td>
                    <td><?php echo $karyawan['nama'];?></td>
                    <td><?php echo $karyawan['npk'];?></td>
                    <td><?php echo $karyawan['masuk'];?></td>
                    <td><?php echo $karyawan['jenis'];?></td>
                    <td><?php echo $karyawan['awal'];?></td>
                    <td><?php echo $karyawan['akhir'];?></td>
