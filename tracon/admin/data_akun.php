          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">KELOLA DATA AKUN KARYAWAN</h3>
              </div>
              ...
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <td><?php echo $no;?></td>
                    ...
                    <td><?php echo $karyawan['pw'];?></td>
                    <td><?php echo $karyawan['lvl'];?></td>
                  </td>
                  <td><a href="delete/hapus_akun.php?npk=<?php echo $karyawan['npk'];?>" class="btn btn-sm btn-danger alert_notif">Hapus</a>
                  <a href="index.php?page=edit-akun&& npk=<?php echo $karyawan['npk'];?>"  class="btn btn-sm btn-success">Edit</a>
                     <!--<td> 
