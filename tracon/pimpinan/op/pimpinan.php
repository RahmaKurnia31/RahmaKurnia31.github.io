        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="index.php?page=data-op" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Diri Karyawan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?page=data-cutiop" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="index.php?page=wait-op" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Menunggu Approval</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?page=app-op" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Approved</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?page=all-op" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Semua data</p>
                </a>
              </li>
