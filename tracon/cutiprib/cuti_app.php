          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> DATA PENERIMAAN CUTI SAYA</h3>
              </div>
              ...
              <!--<button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  $no = 0;
                  $status = "Y";
                  $query = mysqli_query($koneksi,"SELECT * FROM pakai WHERE nama='$_SESSION[nama]' AND status='$status'");
                  ...
                  <td> <?= $karyawan['nomor'] ?></td>
                        ...
                        '<h5><span class="badge badge-warning">Sedang di Proses<i class="fas fa-hourglass-half"></i></span></h5>'
                        : ($karyawan['status']=== 'N'?
                        '<h5><span class="badge badge-danger">Ditolak<i class="fas fa-times"></i></span></h5>'
                        :'<h5><span class="badge badge-success">Diterima<i class="fas fa-check"></i></span></h5>');?>
                        </td>
                        <td><?= $karyawan['manager'] === 'p'? 
                        '<h5><span class="badge badge-warning">Belum Diketahui<i class="fas fa-hourglass-half"></i></span></h5>'
                        : ($karyawan['manager']=== 'N'?
                        '<h5><span class="badge badge-danger">Ditolak<i class="fas fa-times"></i></span></h5>'
                        :'<h5><span class="badge badge-success">Diketahui<i class="fas fa-check"></i></span></h5>');?>
                        </td>
                        <td></td>
                        <!--<td>
                          <?php
                          if($karyawan['status'] == 'p'){
                            ?>
                            <a href="cuti_wait.php?nomor=<?= $karyawan['nomor'] ?>&&s=N" class="btn btn-danger btn-sm"
                            onclick="return confirm('Tolak Pengajuan ini?')">
                            <i class="fas fa-times"></i>
                          </a>
                          <a href="cuti_wait.php?nomor=<? $karyawan['nomor'] ?>&&s=Y" class="btn btn-success btn-sm"
